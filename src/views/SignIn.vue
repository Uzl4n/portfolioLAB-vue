...
import { getAuth, signInWithEmailAndPassword, GoogleAuthProvider, signInWithPopup } from "firebase/auth";  // Importando o GoogleAuthProvider e signInWithPopup
...
<template>
    ...
    <div id="login">
        ...
        <p><button @click="signInWithGoogle" class="btn btn-danger">Sign In With Google</button></p>
    </div>
    <Footer />
</template>
